...
const FuelSpjMonthlyRecap = () => {
  ...
  const handleExportExcel = async () => {
    ...
    try {
      ...
      const worksheet = workbook.addWorksheet('Rekap Bulanan SPJ');
      ...
      worksheet.getCell('A2').value = `REKAP BULANAN SPJ BBM - BULAN: ${months[parseInt(selectedMonth)-1]} ${selectedYear}`;
      ...
      saveAs(new Blob([buffer]), `Rekap_Bulanan_SPJ_BBM_${selectedMonth}_${selectedYear}.xlsx`);
