          ...
          <table className="w-full min-w-[1200px] border-collapse border-2 border-black text-[11px] table-fixed">
            <thead className="pdf-table-header">
              <tr style={{ height: '40px' }}>
                ...
                <th style={headerStyle} className="border-2 border-black p-2 w-[190px]" colSpan={2}>Peralatan</th>
              ...
              <tr style={{ height: '30px' }}>
                {photoMode === "with-photo" && (<><th style={subHeaderStyle} className="border-2 border-black p-1 w-[156px]">0%</th><th style={subHeaderStyle} className="border-2 border-black p-1 w-[156px]">50%</th><th style={subHeaderStyle} className="border-2 border-black p-1 w-[156px]">100%</th></>)}
                <th style={subHeaderStyle} className="border-2 border-black p-1 w-[170px]">Jenis Alat</th>
                <th style={subHeaderStyle} className="border-2 border-black p-1 w-[20px] px-0">Jml</th>
