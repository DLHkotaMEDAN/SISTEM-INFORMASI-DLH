    ...
    <div className="min-h-screen bg-slate-50 p-0 md:p-8">
      ...
      <div className="print-area bg-white p-10 mx-auto shadow-lg border min-h-[210mm] w-full max-w-[297mm]">
        ...
        <div className="text-center mb-8">
          <h3 className="text-lg font-bold underline uppercase">REKAP BULANAN PEMAKAIAN BBM & OLI</h3>
          <p className="font-bold">Bulan: {months[parseInt(selectedMonth)-1]} {selectedYear}</p>
        </div>
        ...
        <table className="w-full border-collapse border-2 border-black text-[8px] table-fixed">
          <thead>
            <tr className="bg-slate-100">
              ...
              <th className="border-2 border-black p-1 w-[55px]">Tanggal</th>
              ...
              <th className="border-2 border-black p-1 w-[160px]">Lokasi Kerja</th>
              ...
              <th className="border-2 border-black p-1 w-[110px]">Keterangan</th>
            </tr>
          </thead>
          <tbody>
            {reports.length > 0 ? (
              reports.flatMap((report, rIdx) => 
                report.items.map((item, iIdx) => (
                  <tr key={`${rIdx}-${iIdx}`}>
                    ...
                    <td className="border-2 border-black p-1 italic text-[7px]">
              ...
              <tr><td colSpan={8} className="border-2 border-black p-8 text-center italic text-slate-400">Tidak ada data untuk bulan ini</td></tr>
            )}
          </tbody>
        </table>
