                ...
                if (isTimPohon) {
                  return (
                    <tr key={plan.id}>
                      ...
                      <td className="border-2 border-black p-1 text-center align-top">{plan.items[0].personnel.members}</td>
                  ...
                  return plan.items.map((item, iIdx) => (
                    <tr key={`${plan.id}-${iIdx}`}>
                      <td className="border-2 border-black p-1 text-center align-top font-bold">{iIdx === 0 ? pIdx + 1 : ""}</td>
                      <td className="border-2 border-black p-1 text-center align-top">
                        {iIdx === 0 ? format(parseISO(plan.date), 'eee, dd MMM', { locale: localeId }) : ""}
                      </td>
                      <td className="border-2 border-black p-1 text-center font-bold align-top">{iIdx === 0 ? plan.category : ""}</td>
