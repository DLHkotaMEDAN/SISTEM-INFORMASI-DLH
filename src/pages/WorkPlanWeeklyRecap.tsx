        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h1 className="font-bold text-sm md:text-base">Rekap Mingguan Rencana</h1>
            </div>
            <div className="flex items-center gap-2">
              <TooltipProvider>
                <Tooltip>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="flex items-center justify-center text-[10px] font-bold text-blue-600 bg-blue-50 px-3 py-2 rounded-md border border-blue-100 h-10">
