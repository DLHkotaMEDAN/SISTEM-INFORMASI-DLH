          ...
          <table className="w-full border-collapse border-2 border-black text-[11px] table-fixed">
            <thead>
              ...
              <tr className="bg-slate-50">
                <th className="border-2 border-black p-1 w-[143px]">0%</th>
                <th className="border-2 border-black p-1 w-[143px]">50%</th>
                <th className="border-2 border-black p-1 w-[143px]">100%</th>
                {recapMode === "with-fuel" && (
                  <>
