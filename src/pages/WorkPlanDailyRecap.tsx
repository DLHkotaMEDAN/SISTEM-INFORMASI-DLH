...
const WorkPlanDailyRecap = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-0 md:p-8">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h1 className="font-bold text-sm md:text-base">Rekap Harian Rencana</h1>
            </div>
            <div className="flex items-center gap-2">
              <TooltipProvider>
                <Tooltip>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <Select value={selectedDate === "semua" ? "semua" : "custom"} onValueChange={(v) => {
              ...
              <SelectTrigger className="h-10"><SelectValue placeholder="Pilih Tanggal" /></SelectTrigger>
              <SelectContent>
            ...
            {selectedDate !== "semua" && (
              <div className="relative">
                ...
                <Input type="date" value={selectedDate} onChange={(e) => setSelectedDate(e.target.value)} className="pl-10 h-10 w-full" />
              </div>
            )}

            <Select value={signatureMode} onValueChange={(v) => setSignatureMode(v as SignatureMode)}>
              <SelectTrigger className="h-10 bg-amber-50 border-amber-200 text-amber-700 font-medium">
      ...
      <div ref={printRef} className="print-area bg-white p-4 md:p-10 mx-auto shadow-lg border min-h-[210mm] w-full max-w-[297mm] overflow-x-auto">
        <div className="min-w-[800px]">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm md:text-lg font-bold">Tanggal: {selectedDate === "semua" ? "Semua Tanggal" : format(new Date(selectedDate), 'dd MMMM yyyy', { locale: localeId })}</p>
          </div>
