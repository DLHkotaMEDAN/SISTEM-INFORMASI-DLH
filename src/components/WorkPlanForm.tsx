...
import { Plus, Trash2, Save, ArrowLeft, Loader2, MapPin, Users, Wrench, FileText, MessageSquare, ClipboardList } from 'lucide-react';
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 max-w-5xl mx-auto pb-20">
        ...
        <div className="space-y-6">
          ...
          <Button type="button" variant="outline" className="w-full border-dashed py-8 text-blue-600 font-bold" onClick={() => appendItem({
            ...
            location: { street: "", village: [""], subDistrict: "" },
            tools: [{ name: "", unit: 1, usage: "" }],
            coordinator: form.getValues("items.0.coordinator") || "",
            personnel: { members: 0 },
