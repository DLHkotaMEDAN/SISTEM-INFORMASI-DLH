...
const roles = ['admin', 'user', 'pimpinan', 'admin_harian', 'spjbbm'];
                    ...
                    <TableCell>
                      ...
                      >
                        <SelectTrigger className={cn(
                          ...
                          profile.role === 'spjbbm' ? "text-blue-600 border-blue-200 bg-blue-50" :
      ...
      <div className="bg-amber-50 border border-amber-200 p-4 rounded-lg flex items-start gap-3 text-amber-800 text-xs">
        ...
        <div className="space-y-1">
          ...
          <ul className="list-disc ml-4 space-y-1">
            ...
            <li>Role <strong>spjbbm</strong> memiliki akses khusus ke fitur Manajemen SPJ BBM.</li>
          </ul>
        </div>
      </div>
    </div>
