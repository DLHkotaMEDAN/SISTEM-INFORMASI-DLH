...
-- 10. POLICIES (Kebijakan Akses Tabel)
...
-- 12. STORAGE BUCKETS (Membuat Bucket report-photos dan assets)
INSERT INTO storage.buckets (id, name, public)
VALUES ('report-photos', 'report-photos', true),
       ('assets', 'assets', true)
ON CONFLICT (id) DO NOTHING;

-- 13. STORAGE POLICIES (Kebijakan Akses File)

-- Kebijakan untuk report-photos
